...
<nav x-data="{ open: false }" class="bg-white border-gray-100">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" wire:navigate>
                        <div class="flex flex-row items-center">
                            ...
                            <div class="ml-3"> <!-- Added margin-left -->
                                <p class="text-md font-extrabold font-poppins uppercase">Mondragon</p>
                                <p class="text-md font-extrabold font-poppins uppercase">Tourism Website</p>
                            </div>
                        </div>
                    </a>
                </div>
                <!-- Navigation Links -->
                <div class="hidden space-x-8 md:space-x-12 lg:space-x-16 sm:-my-px sm:ms-10 lg:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs(['welcome', 'dashboard'])" wire:navigate>
                        {{ __('Home') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden lg:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('welcome')" :active="request()->routeIs(['welcome', 'dashboard'])" wire:navigate>
                {{ __('Home') }}
